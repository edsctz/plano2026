...
export const TIPS: TipData[] = [
  {
    ...
    tools: ["ChatGPT", "Google Gemini", "Perplexity"],
    roi: "Usado em todas ações futuras = economiza horas",
    iconName: "Users"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    subtitle: "Atração - Inbound",
    category: TipCategory.ATTRACTION_INBOUND,
    problem: "Meta Ads e Google Ads têm alta rejeição se o anúncio não é bom.",
    solution: "Cria variações de anúncios otimizados (Títulos, Descrição, CTA).",
  ...
  },
  {
    ...
    solution: "Cria cadência de 4 toques (Email, LinkedIn, WhatsApp) personalizada.",
  ...
  },
  {
    ...
    promptTemplate: "Preciso de lista de empresas para prospectar e vender seguro [TIPO] em [REGIÃO/BAIRRO].\n\nMe crie lista com:\n1. Empresa (nome real)\n2. Tipo (indústria)\n3. Tamanho aproximado\n4. Possível decisor\n5. Potencial fit (1-10)\n6. Argumento específico\n\nCritérios: Empresas médias.",
  ...
  },
  {
    ...
    promptTemplate: "Crie script para um chatbot de WhatsApp e Instagram que vai responder perguntas iniciais sobre seguro [TIPO].\n\nFluxo:\n1. Saudação\n2. Situação atual?\n3. Principal preocupação?\n4. Orçamento?\n5. Urgência?\n\nClassifique em Quente/Morno/Frio.",
  ...
  },
  {
    ...
    promptTemplate: "Ajude-me a priorizar o que fazer na minha corretora de seguros em 2026.  Minha situação atual é [SITUAÇÃO: ex: Tenho poucos leads]. Monte um plano de implementação para as próximas 4 semanas focando no maior impacto imediato.",
